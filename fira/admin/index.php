    ...
    <div class="row ">
      <div class="col s12 m3 "    >
          <ul id="slide-out" class="sidenav sidenav-fixed ">
              ...
              <li><a href="index.php?p=registrasi"><i class="material-icons black-text"></i><b>Registrasi</b></a></li>
              <li><a href="index.php?p=pengaduan"><i class="material-icons black-text"></i><b>Pengaduan</b></a></li>
              <li><a href="index.php?p=user"><i class="material-icons black-text"></i><b>User</b></a></li>
              <li><a href="index.php?p=laporan"><i class="material-icons black-text"></i><b>Laporan</b></a></li>
              <li>
