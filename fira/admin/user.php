        <div class="row">
          <div class="col s12 m9">
            <h3 class="yellow-text"><b>User</b></h3>
          </div>  
	...
	<?php 
		...
		<tr>
			...
			<td><a onclick="return confirm('Anda Yakin Ingin Mengubah Data?')" class="btn blue modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>">Edit</a> <a onclick="return confirm('Anda Yakin Ingin Menghapus Data?')" class="btn red" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>">Hapus</a></td>
